...
public class AppUI extends UI{
    ...
    protected void init(VaadinRequest request) { 
        ...
        czyAdministrator = true;           //bedziemy to sprawdzać logowaniem, narazie zrobione dla sprawdzenia
        czyKierownik = true;                
    ...
    static List<Inventory> updateItemsList(List<Inventory> ItemsList, InventoryRepository repository) {
        ...
        inventoryBazaList = GetItemsFromOurBase(inventoryBazaList, repository);
    ...
    private static List<InventoryBaza> GetItemsFromOurBase(List<InventoryBaza> inventoryBazaList, InventoryRepository repository){
        inventoryBazaList = repository.findAll();
